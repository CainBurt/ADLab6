...
mongoClient = pymongo.MongoClient("mongodb+srv://cain:Password12@advanceddevelopment.tz0f9.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
def forum_cloudfunc():
    url = "https://europe-west2-ad-cain.cloudfunctions.net/mongodbdisplay"
